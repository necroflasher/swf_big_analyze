...
align(1):;
	...
	uint lzmaBodySize;
	// TODO: check this for being too short/long
	...
	ubyte[13] toLzmaHeader(ulong uncompressedDataSize) const
	{
		union U
		{
			LzmaHeader               l;
		...
		return U(LzmaHeader(properties, dictionarySize, uncompressedDataSize)).b;
	}
}
